...
"[project]/src/app/api/consultations/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    ...
    try {
        ...
        if (typeof gotIt !== "boolean") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "gotIt must be boolean"
            }, {
                status: 400
            });
        }
        const updated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$consultations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateConsultationGotIt"])(id, gotIt);
        if (!updated) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Not found"
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07d9c022._.js.map