        ...
        <div className="max-w-4xl">
          ...
          <div ref={line2Ref} className="mt-6 overflow-hidden">
            <p className="text-xl sm:text-2xl text-zinc-400 max-w-2xl leading-relaxed">
              We engineer the success of your vision through technology and innovation.
            </p>
          </div>
          <div ref={ctaRef} className="mt-12 flex flex-wrap gap-12">
            <div className="flex items-center gap-2">
              <span className="text-3xl sm:text-4xl font-bold text-cyan-400">15+</span>
              <span className="text-zinc-500">Industries</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-3xl sm:text-4xl font-bold text-cyan-400">5+</span>
